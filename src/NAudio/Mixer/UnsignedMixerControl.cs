...
namespace NAudio.Mixer
{
	...
	public class UnsignedMixerControl : MixerControl
	{
		...
		internal UnsignedMixerControl(MixerInterop.MIXERCONTROL mixerControl, IntPtr mixerHandle, MixerFlags mixerHandleType,
		                              int nChannels)
		{
		...
		protected override void GetDetails(IntPtr pDetails)
		{
			...
			for (int channel = 0; channel < nChannels; channel++)
			{
				unsignedDetails[channel] =
					...
					Marshal.PtrToStructure(mixerControlDetails.paDetails, typeof (MixerInterop.MIXERCONTROLDETAILS_UNSIGNED));
			}
		}
