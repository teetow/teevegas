...
namespace NAudio.Mixer
{
	internal class MixerInterop
	{
		...
		#region Nested type: MIXERCONTROL
		...
		#region Nested type: MIXERCONTROLDETAILS
		...
		#region Nested type: MIXERCONTROLDETAILS_BOOLEAN
		...
		#region Nested type: MIXERCONTROLDETAILS_LISTTEXT
		...
		#region Nested type: MIXERCONTROLDETAILS_SIGNED
		...
		#region Nested type: MIXERCONTROLDETAILS_UNSIGNED
		...
		#region Nested type: MIXERLINECONTROLS
