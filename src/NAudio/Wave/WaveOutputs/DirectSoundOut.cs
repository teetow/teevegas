...
namespace NAudio.Wave.WaveOutputs
{
	...
	public class DirectSoundOut : IWavePlayer
	{
		...
		private static extern void DirectSoundCreate(IntPtr GUID,
		...
		#region Nested type: BufferDescription
		...
		#region Nested type: DirectSoundBufferCaps
		...
		#region Nested type: DirectSoundBufferLockFlag
		...
		#region Nested type: DirectSoundBufferPositionNotify
		...
		#region Nested type: DirectSoundBufferStatus
		...
		#region Nested type: DirectSoundCooperativeLevel
		...
		#region Nested type: DirectSoundPlayFlags
		...
		#region Nested type: IDirectSound
		...
		#region Nested type: IDirectSoundBuffer
		...
		#region Nested type: IDirectSoundNotify
		...
		internal interface IDirectSoundNotify
		{
			void SetNotificationPositions(UInt32 dwPositionNotifies,
			                              [In, MarshalAs(UnmanagedType.LPArray)] DirectSoundBufferPositionNotify[]
			                              	pcPositionNotifies);
		}
