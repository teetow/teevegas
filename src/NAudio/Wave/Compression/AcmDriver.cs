...
namespace NAudio.Wave.Compression
{
	...
	public class AcmDriver : IDisposable
	{
		...
		public IEnumerable<AcmFormatTag> FormatTags
		{
			get
			{
				if (formatTags == null)
				{
					...
					MmException.Try(
						AcmInterop.acmFormatTagEnum(driverHandle, ref formatTagDetails, AcmFormatTagEnumCallback, IntPtr.Zero, 0),
						"acmFormatTagEnum");
				}
				return formatTags;
			}
		...
		private bool AcmFormatTagEnumCallback(IntPtr hAcmDriverId, ref AcmFormatTagDetails formatTagDetails, IntPtr dwInstance,
