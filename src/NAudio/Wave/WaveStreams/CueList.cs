...
namespace NAudio.Wave.WaveStreams
{
	...
	public class CueList
	{
		...
		internal CueList(byte[] cueChunkData, byte[] listChunkData)
		{
			...
			int labelChunkID = WaveInterop.mmioStringToFOURCC("labl", 0);
		...
		internal byte[] GetRIFFChunks()
		{
			...
			else
			{
				...
				int cueChunkID = WaveInterop.mmioStringToFOURCC("cue ", 0);
				int dataChunkID = WaveInterop.mmioStringToFOURCC("data", 0);
				int listChunkID = WaveInterop.mmioStringToFOURCC("LIST", 0);
				int adtlTypeID = WaveInterop.mmioStringToFOURCC("adtl", 0);
				int labelChunkID = WaveInterop.mmioStringToFOURCC("labl", 0);
